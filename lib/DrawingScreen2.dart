...
class DrawingScreen2 extends StatefulWidget {
  const DrawingScreen2({super.key});

  @override
  State<DrawingScreen2> createState() => _DrawingScreen2State();
}

class _DrawingScreen2State extends State<DrawingScreen2> {
